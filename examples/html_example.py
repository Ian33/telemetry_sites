...
app.layout = html.Div(
                children = [html.Div(className = "row", children = [html.Div(html.H2("title"),html.P("""html """),),])])


app.layout = html.Div(children = [html.Div(className = "row", children = html.Div()), 
                                  html.Div(className = "graph", children = html.Div())])
...
app.layout = html.Div(children=[html.Div(
                className="row", children=[html.Div(
                            ...
                            children=[
                                ...
                                html.P("""Select different days """),
                                html.Div(className="div-for-dropdown",children=[],),
                                # Change to side-by-side for mobile layout
                                html.Div(className="row", children=[html.Div(className="div-for-dropdown", children=[dcc.Dropdown(id="location-dropdown",options=[{"label": i, "value": i}for i in list_of_locations],placeholder="Select a location",)],), html.Div(className="div-for-dropdown",children=[dcc.Dropdown(id="bar-selector", options=[{"label": str(n) + ":00", "value": str(n),} for n in range(24)],multi=True,placeholder="Select certain hours",) ],),],),
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(className="text-padding",children=["Select any of the bars on the histogram to section data by time."],),
